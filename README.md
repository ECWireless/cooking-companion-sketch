...
Use the API from [`raid-guild/pinata-voice-cooking-companion`](https://github.com/raid-guild/pinata-voice-cooking-companion) as the backend for `API_ORIGIN` and `API_URL_BASE`.
...
The current sketch expects the [`pinata-voice-cooking-companion`](https://github.com/raid-guild/pinata-voice-cooking-companion) API, or a compatible protected recipe helper API, with:
